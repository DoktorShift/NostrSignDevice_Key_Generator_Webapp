      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            />
            <span className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-green-700 bg-clip-text text-transparent">
              <span className="bg-gradient-to-r from-black via-slate-800 to-black bg-clip-text text-transparent">
                Buho
              </span>
            </span>
          </a>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            {/* Signing Apps Dropdown */}
            <div className="relative">
              <button
                onClick={() => setIsSigningAppsOpen(!isSigningAppsOpen)}
                className="flex items-center text-slate-700 hover:text-black transition-colors font-medium px-3 py-2 rounded-lg hover:bg-green-50"
              >
                Signing Apps
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-gray-200/50 py-2 z-20 backdrop-blur-xl">
                    ...
                    {signingApps.map((app) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block px-4 py-3 hover:bg-green-50 transition-colors group"
                        onClick={() => setIsSigningAppsOpen(false)}
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="font-medium text-black group-hover:text-green-700 transition-colors">
                              {app.name}
                            </div>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <ExternalLink className="w-3 h-3 text-slate-400 group-hover:text-green-500 transition-colors" />
                          </div>
                        </div>
                      </a>
                    ))}
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-slate-700 hover:text-black transition-colors font-medium px-3 py-2 rounded-lg hover:bg-green-50 flex items-center"
            >
              Apps
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-gray-900 to-black hover:from-black hover:to-gray-800 text-white px-6 py-2 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] flex items-center"
            >
          ...
          <div className="md:hidden py-4 border-t border-gray-200/50">
            <div className="flex flex-col space-y-4">
              ...
              <div>
                <button
                  onClick={() => setIsSigningAppsOpen(!isSigningAppsOpen)}
                  className="flex items-center justify-between w-full text-slate-700 hover:text-black transition-colors font-medium px-3 py-2 rounded-lg hover:bg-green-50"
                >
                  Signing Apps
                  ...
                  <div className="mt-2 ml-4 space-y-2">
                    {signingApps.map((app) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block py-2 text-sm text-slate-700 hover:text-black transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-gray-900 to-black hover:from-black hover:to-gray-800 text-white px-6 py-2 rounded-xl font-medium transition-all duration-200 w-full shadow-lg hover:shadow-xl flex items-center justify-center"
              >
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                </svg>
